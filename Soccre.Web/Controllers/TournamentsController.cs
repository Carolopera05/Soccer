    ...
    public class TournamentsController : Controller
    {
        ...
        public async Task<IActionResult> Edit(TournamentViewModel model)
        {
            if (ModelState.IsValid)
            {
                ...
                TournamentEntity tournamentEntity = _converterHelper.ToTournamentEntity(model, path, false);//converter
        ...
        public async Task<IActionResult> Details(int? id)
        {
            ...
            TournamentEntity tournamentEntity = await _context.Tournaments
                ...
                .Include(t => t.Groups)
                .ThenInclude(t => t.Matches)
                .ThenInclude(t => t.Visitor)//relation one level include , second level theninclude
                .Include(t => t.Groups)
